...
int circular_buf_try_put(cbuf_handle_t cbuf, uint64_t data);
...
int circular_buf_peek(cbuf_handle_t cbuf, uint64_t* data, unsigned int look_ahead_counter);

// TODO: int circular_buf_get_range(circular_buf_t cbuf, uint64_t *data, size_t len);
// TODO: int circular_buf_put_range(circular_buf_t cbuf, uint64_t * data, size_t len);
